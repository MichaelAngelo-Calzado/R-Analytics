...
```{r}
cate2b <- c("Category 1: WATCH", "Category 2:", "Category 3:", "Category 4:", "Category 5:")
...
```
```{r}
productnumbe2b <- c("Product 9", "Product 10")
...
```{r}
nama11 <- names2[[3]]
namez11 <- nama11[!grepl("Moisturizing Cream", nama11, ignore.case = TRUE)]
namez11 <- namez11[-(1:2)]
...
skincare3 <- data.frame(Category = ca11,
                     Product_number = producto11,
                      ...
                      Userame = namez11,
                       Rating = ratingz11,
                       Date = dates1b[[3]],
                       Title_of_Review = title1b[[3]],
                       Text_of_Review = text1b[[3]],
                       stringsAsFactors = FALSE
                       )
head(skincare3, 50)
skincare3 %>%
