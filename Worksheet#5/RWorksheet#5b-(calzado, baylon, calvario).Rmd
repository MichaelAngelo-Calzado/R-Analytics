...
```
```{r}
skincare1 <- data.frame(Category = ca9,
...
nr <- which(namez14 == "Holly Manfred") + 1
namez14 <- append(namez14, "Rachel", after = nr - 1)
...
```
```{r}
urls5 <- c('https://www.amazon.com/Amazon-Essentials-Slim-Fit-Stretch-Black/dp/B07BJKTXX3/ref=sr_1_1_ffob_sspa?crid=27TSZ91XTCRLW&dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BYVs1xuBogfsFXjGr21eELTn-kCQqhVS37mhEpiq1V30lPN2Nfn3b18GfyLXbY4K5rdG_iAcI6uDZ6-uuySkYD2owEBW5Mpj4wvMjZm99wDcJEeEEjSs76L0BamJLfkfmF48qFhaz1j2q8BuJs9zxjIY0inNy_Va296tTcK-MipEAzumwTOWlAoVvYYllskGuILEXwm8IwkWJZDhYKhPMpdHFia1EvTXgnfCE_IB2r0hqmm6SWDQi48n1-gWkn_8Wp7ElOGqSkvjAY-xfOvdAiY.gq-wH65kx5Udvj3-j5xR_blV-FIoERShoIiXZzK5X3c&dib_tag=se&keywords=pants&qid=1733754251&sprefix=pants%2Caps%2C468&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1','https://www.amazon.com/BROKIG-Workout-Bodybuilding-Sweatpants-Pockets/dp/B07WN15P5P/ref=sr_1_3_sspa?crid=27TSZ91XTCRLW&dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BYVs1xuBogfsFXjGr21eELTn-kCQqhVS37mhEpiq1V30lPN2Nfn3b18GfyLXbY4K5rdG_iAcI6uDZ6-uuySkYD2owEBW5Mpj4wvMjZm99wDcJEeEEjSs76L0BamJLfkfmF48qFhaz1j2q8BuJs9zxjIY0inNy_Va296tTcK-MipEAzumwTOWlAoVvYYllskGuILEXwm8IwkWJZDhYKhPMpdHFia1EvTXgnfCE_IB2r0hqmm6SWDQi48n1-gWkn_8Wp7ElOGqSkvjAY-xfOvdAiY.gq-wH65kx5Udvj3-j5xR_blV-FIoERShoIiXZzK5X3c&dib_tag=se&keywords=pants&qid=1733756497&sprefix=pants%2Caps%2C468&sr=8-3-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1','https://www.amazon.com/dp/B08F3HJL2W/ref=sspa_dk_detail_0?psc=1&pd_rd_i=B08F3HJL2W&pd_rd_w=UAkma&content-id=amzn1.sym.10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_p=10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_r=G6723859P14MZYAX66GK&pd_rd_wg=78AZX&pd_rd_r=dd950c98-8023-4103-a8c6-022b0ed35cd1&s=apparel&sp_csd=d2lkZ2V0TmFtZT1zcF9kZXRhaWxfdGhlbWF0aWM','https://www.amazon.com/dp/B07QRZBPGV/ref=sspa_dk_detail_0?psc=1&pd_rd_i=B07QRZBPGV&pd_rd_w=cvp6B&content-id=amzn1.sym.10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_p=10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_r=4VK2P5P59VYSHX14SNJD&pd_rd_wg=fwLso&pd_rd_r=8b95485b-060b-4185-9328-6ec8322dfe6e&s=apparel&sp_csd=d2lkZ2V0TmFtZT1zcF9kZXRhaWxfdGhlbWF0aWM','https://www.amazon.com/dp/B07WN15P5P/ref=sspa_dk_detail_0?psc=1&pd_rd_i=B07WN15P5P&pd_rd_w=5sAbZ&content-id=amzn1.sym.10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_p=10c716f0-b18a-473a-9d6a-5d87bc47ef1e&pf_rd_r=DKY06K4XA7RV8HJANSDZ&pd_rd_wg=ZLD4N&pd_rd_r=0ae490c0-b5ec-420b-89d4-71782dbced71&s=apparel&sp_csd=d2lkZ2V0TmFtZT1zcF9kZXRhaWxfdGhlbWF0aWM')
...
```{r}
nama5 <- names5[[1]]
namez5 <- nama5[!grepl("Amazon Essentials Men's Slim-Fit Jeans", nama5, ignore.case = TRUE)]
...
```{r}
nama52 <- names5[[1]]
name52 <- nama52[!grepl("BROKIG Mens Gym Jogger Pants,Casual Slim Workout Sweatpants with Zipper Pockets Bodybuilding Athletic Pants", nama52, ignore.case = TRUE)]
...
```{r}
nama53 <- names5[[3]]
namez53 <- nama53[!grepl("BROKIG Mens Lightweight Gym Jogger Pants,Men's Workout Sweatpants with Zip Pocketr", nama53, ignore.case = TRUE)]
namez53 <- namez53[-(1:2)]
...
```{r}
nama55 <- names5[[5]]
namez55 <- nama55[!grepl("BROKIG Mens Gym Jogger Pants,Casual Slim Workout Sweatpants with Zipper Pockets Bodybuilding Athletic Pantss", nama55, ignore.case = TRUE)]
namez55 <- namez55[-(1:2)]
...
```
```{r}
urls5b <- c('https://www.amazon.com/Wrangler-Authentics-Relaxed-Stretch-Cargo/dp/B0BTRMKQW5/ref=sr_1_6?dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BQEAx7Lju222fMupvQJu2rVIXc909ErUfmNRjUtKWzP_liVuPYd9ZRcKbBizYMJ9xTAGoKM_RP7260aLRx2IbrHJwRLl01ZA-3t0FWWaef07BftP5QoyZvRqGOsi6Z7ZSnKbzBtBT-beIhZ0EfQ8h1Bpv4ZHvE9to24bec4rvvCBC01G_aO__RoJEFT2Sx0zJmfCz9deWM7USLlAd68ygH0-mmh6MgukZAeirtNO3n2hyDtmVSAROzbn7YuR9zofaOfKPAxOOIr5xLIQ8nFC_sg.ZfOVK2JcrdlQPqGEXjljkpeiZ7nKtWsxODiaQGJUFNs&dib_tag=se&keywords=pants&qid=1733793880&sr=8-6','https://www.amazon.com/GYM-PEOPLE-Pockets-Control-Leggings/dp/B07HQPKDZB/ref=sr_1_8?dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BQEAx7Lju222fMupvQJu2rVIXc909ErUfmNRjUtKWzP_liVuPYd9ZRcKbBizYMJ9xTAGoKM_RP7260aLRx2IbrHJwRLl01ZA-3t0FWWaef07BftP5QoyZvRqGOsi6Z7ZSnKbzBtBT-beIhZ0EfQ8h1Bpv4ZHvE9to24bec4rvvCBC01G_aO__RoJEFT2Sx0zJmfCz9deWM7USLlAd68ygH0-mmh6MgukZAeirtNO3n2hyDtmVSAROzbn7YuR9zofaOfKPAxOOIr5xLIQ8nFC_sg.ZfOVK2JcrdlQPqGEXjljkpeiZ7nKtWsxODiaQGJUFNs&dib_tag=se&keywords=pants&qid=1733793880&sr=8-8','https://www.amazon.com/Amazon-Essentials-Classic-Fit-Wrinkle-Resistant-Flat-Front/dp/B06XWMJH3K/ref=sr_1_7?dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BQEAx7Lju222fMupvQJu2rVIXc909ErUfmNRjUtKWzP_liVuPYd9ZRcKbBizYMJ9xTAGoKM_RP7260aLRx2IbrHJwRLl01ZA-3t0FWWaef07BftP5QoyZvRqGOsi6Z7ZSnKbzBtBT-beIhZ0EfQ8h1Bpv4ZHvE9to24bec4rvvCBC01G_aO__RoJEFT2Sx0zJmfCz9deWM7USLlAd68ygH0-mmh6MgukZAeirtNO3n2hyDtmVSAROzbn7YuR9zofaOfKPAxOOIr5xLIQ8nFC_sg.ZfOVK2JcrdlQPqGEXjljkpeiZ7nKtWsxODiaQGJUFNs&dib_tag=se&keywords=pants&qid=1733793880&sr=8-7','https://www.amazon.com/Hanes-EcoSmart-Sweatpant-Pockets-Charcoal/dp/B07FN591SL/ref=sr_1_6?crid=1BITIL2VZEU47&dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BQEAx7Lju222fMupvQJu2rVIXc909ErUfmNRjUtKWzP_liVuPYd9ZRcKbBizYMJ9xTAGoKM_RP7260aLRx2IbrHJwRLl01ZA-3t0FWWaef07BftP5QoyZvRqGOsi6Z7ZSnKbzBtBT-beIhZ0EfQ8h1Bpv4ZHvE9to24bec4rvvCBC01G_aO__RoJEFT2Sx0zJmfCz9deWM7USLlAd68ygH0-mmh6MgukZAeirtNO3n2hyDtmVSAROzbn7YuR9zofaOfKPAxOOIr5xLIQ8nFC_sg.ZfOVK2JcrdlQPqGEXjljkpeiZ7nKtWsxODiaQGJUFNs&dib_tag=se&keywords=pants&qid=1733794068&sprefix=pants%2Caps%2C396&sr=8-6','https://www.amazon.com/G4Free-Pockets-Palazzo-Fashion-Sweatpants/dp/B0CR5NHMB2/ref=sr_1_18?crid=1BITIL2VZEU47&dib=eyJ2IjoiMSJ9.lxTaNXjcDhEwKCXa5-a-BQEAx7Lju222fMupvQJu2rVIXc909ErUfmNRjUtKWzP_liVuPYd9ZRcKbBizYMJ9xTAGoKM_RP7260aLRx2IbrHJwRLl01ZA-3t0FWWaef07BftP5QoyZvRqGOsi6Z7ZSnKbzBtBT-beIhZ0EfQ8h1Bpv4ZHvE9to24bec4rvvCBC01G_aO__RoJEFT2Sx0zJmfCz9deWM7USLlAd68ygH0-mmh6MgukZAeirtNO3n2hyDtmVSAROzbn7YuR9zofaOfKPAxOOIr5xLIQ8nFC_sg.ZfOVK2JcrdlQPqGEXjljkpeiZ7nKtWsxODiaQGJUFNs&dib_tag=se&keywords=pants&qid=1733794068&sprefix=pants%2Caps%2C396&sr=8-18')
...
```{r}
nama5b <- names5b[[1]]
namez5b <- nama5b[!grepl("AWrangler Authentics Men's Relaxed Fit Stretch Cargo Pantr", nama5b, ignore.case = TRUE)]
namez5b <- unique(namez5b)
namez5b <- namez5b[-1]
producto5b <- productnumber5[[1]]
...
```{r}
nama5b2 <- names5b[[2]]
namez5b2 <- nama5b2[!grepl("THE GYM PEOPLE Thick High Waist Yoga Pants with Pockets, Tummy Control Workout Running Yoga Leggings for Womenr", nama5b2, ignore.case = TRUE)]
namez5b2 <- unique(namez5b2)
namez5b2 <- namez5b2[-(2:2)]
producto5b2 <- productnumber5[[2]]
...
```{r}
nama5b3 <- names5b[[3]]
namez5b3 <- nama5b3[!grepl("Amazon Essentials Men's Classic-Fit Wrinkle-Resistant Flat-Front Chino Pant", nama5b3, ignore.case = TRUE)]
namez5b3 <- namez5b3[-(1:2)]
namez5b3 <- unique(namez5b3)
producto5b3 <- productnumber5[[3]]
...
```{r}
nama5b4 <- names5b[[4]]
namez5b4 <- nama5b4[!grepl("Hanes ComfortSoft EcoSmart Men's Fleece Sweatpants", nama5b4, ignore.case = TRUE)]
...
```{r}
nama5b5 <- names5b[[5]]
namez5b5 <- nama5b5[!grepl("G4Free Yoga Pants Women Wide Leg Pants with Pockets High Waist Stretch Dress Casual Sweatpants", nama5b5, ignore.case = TRUE)]
namez5b5 <- namez5b5[-(1:2)]
namezb5 <- unique(namez5b5)
